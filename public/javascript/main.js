   ...
   'use strict'
                ...
                submitHandler: function( form ) {
                    ...
                    $.ajax({
                        ...
                        success: function( msg ) {
                            var result, cls;                            
                            if ( msg === 'Success' ) {result = 'We have recieved your request. We will get back to you soon!'; cls = 'msg-success'; } else {result = 'Error sending email.'; cls = 'msg-error'; } $form.prepend(
                                $('<div />', {
    ...
    var retinaLogos = function() {
      var retina = window.devicePixelRatio > 1 ? true : false;
        ...
        if(retina) {
            $('.logo').find('img').attr( {src:'/images/logo-black.png',width:'200',height:'46'} );   
        }
        $('.logo-footers').find('img').attr( {src:'/images/logo-white.png',width:'200',height:'46'} );   
       // $('.logo-header').find('img').attr( {src:'/images/logo-black.png',width:'200',height:'46'} );   

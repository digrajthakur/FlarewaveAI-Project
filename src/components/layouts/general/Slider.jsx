                    ...
                    {/* <!-- SLIDE 3 --> */}
                        <li data-index="rs-3049" data-transition="slideremovedown" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"    data-rotate="0"  data-saveperformance="off"  data-title="Ken Burns" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">                        
                            ...
                            <div className="tp-caption title-slide color-white letter-spacing3px" 
                                ...
                                >Your Trusted<br /> Development Partner
                            </div>
                            ...
                            <div className="tp-caption sub-title color-white" 
                                ...
                                data-paddingbottom="[0,0,0,0]"
                                data-paddingleft="[0,0,0,0]"
                                >Our design-focused perspective and project development <br />processes help you to deliver the right solutions. 
                                {/* >With over 10 years of experience helping businesses to find<br />comprehensive solutions  */}
                            </div>

                            <Link to="/about-us" onClick={() => {window.location.href='/about-us'}} target="_self" className="tp-caption flat-button-slider bg-blue" 
                            ...
                            <Link to="/contact" onClick={() => {window.location.href='/contact'}} target="_self" className="tp-caption flat-button-slider bg-transparent" 
                        ...
                        <li data-index="rs-3048" data-transition="slideremovedown" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"    data-rotate="0"  data-saveperformance="off"  data-title="Ken Burns" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">                        
                            ...
                            {/* <!-- MAIN IMAGE --> */}
                            <img src="images/slides/slide2.png"  alt=""  data-bgposition="center center" data-kenburns="off" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" className="rev-slidebg" data-no-retina />
                            {/* <!-- LAYERS --> */}
                            ...
                            <div className="tp-caption sub-title color-white" 
                                ...
                                data-paddingbottom="[0,0,0,0]"
                                data-paddingleft="[0,0,0,0]"
                                >We deliver web and mobile development services to all <br /> type of businesses, with 100% project delivery success.
                                {/* >With over 10 years of experience helping businesses to find<br />comprehensive solutions  */}
                            </div>
